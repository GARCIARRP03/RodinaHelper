...
function main()
	autoupdate("https://raw.githubusercontent.com/GARCIARRP03/update1rrp/main/script_version.json", '['..string.upper(thisScript().name)..']: ', "https://github.com/GARCIARRP03/update1rrp/blob/main/script_version.json"
